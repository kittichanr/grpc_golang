...
func (server *LaptopServer) UploadImage(stream proto.LaptopService_UploadImageServer) error {
	req, err := stream.Recv()
	if err != nil {
...
func (server *LaptopServer) RateLaptop(stream proto.LaptopService_RateLaptopServer) error {
	for {
